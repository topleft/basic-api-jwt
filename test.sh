...
CONTAINER_ID=$(docker run -e BASIC_DB_TEST=postgres://postgres@host.docker.internal:5432/basic_db_test -e TOKEN_SECRET -e NODE_ENV topleft/api-boiler-test:latest)
